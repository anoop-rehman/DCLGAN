#!/bin/bash
#SBATCH --job-name=sim2real_DCL_tuned
...
# Tuned loss weights for structural fidelity
LAMBDA_GAN=0.5
LAMBDA_NCE=10.0
LAMBDA_IDT=5.0
...
echo "Loss weights : GAN=${LAMBDA_GAN} NCE=${LAMBDA_NCE} IDT=${LAMBDA_IDT}"
